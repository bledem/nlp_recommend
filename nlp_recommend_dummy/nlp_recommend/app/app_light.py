...
def predict():
    ...
    preds['adv'] = {"author":"Mundy","quote":"\"going up today?\" he asked","recommended_title":{"author":"Mundy","title":"The Ivory Trail"},"title":"The ivory trail"}
    preds['philo'] = {"author":"Plato","quote":"What are you going to say?","recommended_title":{"author":"Plato","title":"Phaedrus"},"title":"Phaedrus"}
    preds['psycho'] = {"author":"Healy","quote":"Is going to try them","recommended_title":{"author":"Healy","title":"Pathology of Lying, Accusation, and Swindling: A Study in Forensic Psychology"},"title":"Pathology of lying, accusation, and swindling: a study in forensic psychology"}
    # Add to database
